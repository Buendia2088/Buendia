...
int main()
{
    ...
    //println("Totally {} productions", generTable.table.size());
    // Output the parsed grammar
    // cout << "Parsed Grammar:" << endl;
    // for (const auto& gener : generTable.table)
    // {
    //     cout << gener.left << " -> ";
    //     for (const auto& right : gener.right)
    //     {
    //         cout << right << " ";
    //     }
    //     cout << endl;
    ...
    // // Output non-terminal and terminal symbols
    // cout << "\nNon-Terminal Symbols:" << endl;
    // for (const auto& nt : generTable.nonTerminal)
    // {
    //     cout << nt << " ";
    // }
    // cout << "\n\nTerminal Symbols:" << endl;
    // for (const auto& t : generTable.terminal)
    // {
    //     cout << t << " ";
    // }
    // cout << endl;
