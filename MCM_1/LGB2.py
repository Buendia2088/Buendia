...
# 设置样本权重
#sample_weights = y_train.map({-100: 100, 0: 1, 100: 100})  # 根据实际情况调整权重
...
'''
# 预测新数据集
X_new = pd.read_csv('/home/chengyuan/PYT/standardized_combined_woman.csv', encoding='gbk', header=None)
